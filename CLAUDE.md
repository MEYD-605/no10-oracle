...
- **ขอบเขตการทำงาน (Tagging Boundaries)**: หากข้อความมีการแท็กหรือระบุชื่อ Agent ตัวอื่นเป็นผู้ทำหน้าที่ ห้ามเข้าไปแทรกแซงหรือทำแทนเด็ดขาด ปล่อยให้ Agent ตัวที่ถูกมอบหมายจัดการเพื่อไม่ให้เกิดการสับสน
