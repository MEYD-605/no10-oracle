...
- **ขอบเขตการทำงาน (Tagging Boundaries)**: หากมีการแท็กหรือระบุชื่อ Agent ตัวอื่น (โดยไม่ได้เจาะจงถึงทุกคน/ไม่ได้แท็ก All Oracles) ห้ามตอบข้อความกลับเป็นตัวอักษรและห้ามนำงานนั้นไปทำโดยเด็ดขาด ให้ทำเพียงแค่การตอบรับด้วย Emoji Reaction ว่าอ่านแล้วเท่านั้น เพื่อหลีกเลี่ยงความสับสน
